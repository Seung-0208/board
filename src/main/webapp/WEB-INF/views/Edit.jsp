...
<head>
	...
	<div class="align-items-start" style="width:100%; background-color:#FFFFFF; height:300px">
		...
		<div class="col"></div>
		<div class="col" style="padding-top:150px; display:flex; justify-content:center;"><h1 class="display-3">글을 수정하세요!</h1></div>
		<div class="col"></div>
		</div>
	</div>
  ...
  <div id="form-div" style="margin-left: 0; left:auto;">
    ...
    <form method="post" action="<c:url value="/Proj/Service/Edit.ict?no=${record.no }"/>">
      <div class="my-3">
        <input  name="title" type="text" class="validate[required,custom[onlyLetter],length[0,100]] feedback-input" placeholder="Title" id="name" value="${record.title }" />
      </div>
      ...
      <div class="mt-3">
      	...
      	<!-- 로딩 -->
        <textarea style="font-size: 14px;height:300px;" name="content" class="validate[required,length[6,300]] feedback-input" id="content" placeholder="Content">${record.content }</textarea>
      </div>
      <div>
